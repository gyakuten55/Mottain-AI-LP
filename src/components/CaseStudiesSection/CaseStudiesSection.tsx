              ...
              <SwiperSlide key={study.id}>
                <div className={styles.caseCard}>
                  ...
                  <div className={styles.companyInfo}>
                    <h3 className={styles.companyName}>{study.companyName}</h3>
                      ...
                      <div className={styles.comparisonBars}>
                        <div className={styles.barRow}>
                          ...
                          <div className={styles.barContainer}>
                            <div className={`${styles.bar} ${styles.barBefore}`}>
                              <span className={styles.barText}>外注費</span>
                            </div>
                          </div>
                        </div>
                        <div className={styles.barRow}>
                          ...
                          <div className={styles.barContainer}>
                            <div className={styles.barAfterWrapper}>
                              <div className={styles.barAfterLeft}>
                                <span className={styles.barText}>内製化</span>
                              </div>
                              <div className={styles.barAfterRight}>
                                <span className={styles.barText}>利益</span>
                              </div>
                            </div>
                          </div>
                        </div>
